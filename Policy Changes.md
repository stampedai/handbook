...
The handbook is hosted on Github, and anyone with a Github account can make an issue or open a pull request. This is an important home for the project, and we want to encourage and reward participation. We should respond to issues and comments here and use the edits in pull requests when they’re appropriate. Simon will do this regularly, and anyone else is free to respond when they're interested. This will help more people feel bought into the handbook and will help us gather more opinions on our policies.
...
During our weekly team lunch, Simon will summarize open issues and proposals.
...
Every proposal should have an open meeting for feedback from the team. Simon will schedule these, and will be there for all of these discussions. Everyone is invited to all of these discussions, though attendance is not required. Participation in these conversations is really important because this is the best place for us to get a sense of how different team members relate to or will be impacted by a certain policy.
...
After changes have been proposed, discussed, and Simon decides they are ready to be merged into the handbook, Simon will do the merge on Github, update the card on Trello, post about it in Slack, and send an email.
